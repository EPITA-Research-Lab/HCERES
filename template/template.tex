...
\usubsubsection{Domaine 1. Profil, ressources et organisation de l'unité}
...
\uparagraph{Référence 1. L'unité s'est assigné des objectifs scientifiques
  pertinents.}
...
\uparagraph{Référence 2. L'unité dispose de ressources adaptées à son profil
...
\uparagraph{Référence 3. Les pratiques de l'unité sont conformes aux règles et
  aux directives définies par ses tutelles en matière de gestion des
  ressources humaines, de sécurité, d'environnement, de protocoles éthiques et
  de protection des données ainsi que du patrimoine scientifique.}
...
\uparagraph{Référence 1. L'unité est attractive par son rayonnement
...
\uparagraph{Référence 2. L'unité est attractive par la qualité de sa politique
...
\uparagraph{Référence 3. L'unité est attractive par la reconnaissance de ses
  succès à des appels à projets compétitifs.}
...
\uparagraph{Référence 4. L'unité est attractive par la qualité de ses
...
\usubsubsection{Domaine 3. Production scientifique}
...
\uparagraph{Référence 1. La production scientifique de l'unité satisfait à des
  critères de qualité.}
...
\uparagraph{Référence 2. La production scientifique de l'unité est
  proportionnée à son potentiel de recherche et correctement répartie entre
  ses personnels.}
...
\uparagraph{Référence 3. La production scientifique de l'unité respecte les
  principes de l'intégrité scientifique, de l'éthique et de la science
...
\usubsubsection{Domaine 4. Inscription des activités de recherche dans la
  société}
...
\uparagraph{Référence 1. L'unité se distingue par la qualité et la quantité de
  ses interactions avec le monde non-académique.}
...
\uparagraph{Référence 2. L'unité développe des produits à destination du monde
...
\uparagraph{Référence 3. L'unité partage ses connaissances avec le grand
...
\usubsubsection{Équipe 1 (skelette à reproduire pour chaque équipe)}

\uparagraph{Thématiques scientifiques et enjeux}
...
\uparagraph{Profil d'activités liées à la recherche}

\uparagraph{Prise en compte des recommandations du précédent rapport}

\uparagraph{Introduction du portfolio}

\uparagraph{Auto-évaluation de l'équipe}

\uparagraph{Trajectoire de l'équipe}
