...
\addcontentsline{toc}{subsubsection}{Équipe 1 (skelette à reproduire pour chaque équipe)}
...
\addcontentsline{toc}{paragraph}{Profil d'activités liées à la recherche}

\paragraph*{Prise en compte des recommandations du précédent rapport}
\addcontentsline{toc}{paragraph}{Prise en compte des recommandations du précédent rapport}
