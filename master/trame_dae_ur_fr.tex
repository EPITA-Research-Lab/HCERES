...
\hypersetup{
            pdftitle={DOCUMENT D'AUTOÉVALUATION DES UNITÉS DE RECHERCHE},
            pdfborder={0 0 0},
            breaklinks=true}
...
\chead{}
\rhead{\raisebox{-.5\height}{\includegraphics[width=1.5cm]{hcereslogo}}}
\lfoot{Campagne d’évaluation \@campaign{} – Vague \@wave\hspace{1cm} Département d’évaluation de la recherche}
\cfoot{}
\rfoot{\thepage}
...
\newcommand\campaign[1]{\def\@campaign{#1}}
\newcommand\wave[1]{\def\@wave{#1}}
...
\newcommand*\usection[1]{%
  \section*{#1}\addcontentline{toc}{section}{#1}}
\newcommand*\usubsection[1]{%
  \subsection*{#1}\addcontentline{toc}{subsection}{#1}}
\newcommand*\usubsubsection[1]{%
  \subsubsection*{#1}\addcontentline{toc}{subsubsection}{#1}}
\newcommand*\uparagraph[1]{%
  \paragraph*{#1}\addcontentline{toc}{paragraph}{#1}}

\AtBeginDocument{%
\begin{titlepage}
\tikz[remember picture,overlay] \node[inner sep=0pt] at ([xshift=8.5cm,yshift=-3cm]current page.north west){\raisebox{-.5\height}{\includegraphics[width=4cm]{hcereslogo}}  \Large\bf\color{hceresred} Département d’évaluation de la recherche};
...
\vskip 2cm
{\raggedright\color{hceresred}\bf\large CAMPAGNE D'EVALUATION \@wave
}\\
{\raggedright\color{hceresred}\large Vague \@wave
}
\par\vskip 2cm
...
\subsubsection*{Équipe 1 (skelette à reproduire pour chaque équipe)}
\addcontentsline{toc}{subsubsection}{Équipe 1 (skelette à reproduire
pour chaque équipe)}

\paragraph*{Thématiques scientifiques et enjeux}
\addcontentsline{toc}{paragraph}{Thématiques scientifiques et enjeux}
...
\paragraph*{Profil d'activités liées à la recherche}
\addcontentsline{toc}{paragraph}{Profil d'activités liées à la
recherche}

\paragraph*{Prise en compte des recommandations du précédent rapport}
\addcontentsline{toc}{paragraph}{Prise en compte des recommandations du
précédent rapport}

\paragraph*{Introduction du portfolio}
\addcontentsline{toc}{paragraph}{Introduction du portfolio}

\paragraph*{Auto-évaluation de l'équipe}
\addcontentsline{toc}{paragraph}{Auto-évaluation de l'équipe}

\paragraph*{Trajectoire de l'équipe}
\addcontentsline{toc}{paragraph}{Trajectoire de l'équipe}
